...
class Ion_auth_model extends CI_Model
{
	...
	public function login($identity, $password, $remember=FALSE)
	{
		...
		$query = $this->db->select($this->identity_column . ', email, users.id, password, active, last_login,firstname, lastname')
	...
	public function login_remembered_user()
	{
		...
		$this->trigger_events('extra_where');
		$query = $this->db->select($this->identity_column . ', users.id, email, remember_code, last_login, firstname, lastname')
							->join('names','names.user_id=users.user_id')
