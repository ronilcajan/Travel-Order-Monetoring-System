            ...
            <ul class="list-inline pull-right">
                <li>
                    <div class="card-tools">
                        <a href="<?= site_url('admin/officials/create') ?>"
        ...
        <table class="display nowrap color-table info-table" cellspacing="0" width="100%" id="officialTable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?= $row->position ?></td>
                    <td><?= $row->division ?></td>
                    <td><?= $row->approver == 1 ? '<span class="label label-table label-primary">Yes</span>' : '<span class="label label-danger">No</span>' ?>
                    </td>
                    <td class="text-nowrap noPrint">
                        <a type="button" href="<?= site_url('admin/officials/edit/') . $row->id ?>"
                            data-toggle="tooltip" onclick="editOfficial(this)" title="Edit Official"> <i
